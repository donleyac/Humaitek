...
var BoxData =  {
  data: [
  (<Box  height={2} width={1} date={"11/25"} category={"important"} context=(<p><span className="text-emph">Humaitek</span> is a design and innovation
  ...
  (<Box height={1} width={1} date={"11/25"} category={"important"} context=(<div className="contact-box col-sm-6 grid">
  ...
  (<Box height={1} width={1} date={"11/25"} category={"normal"} context=(<img class="img-responsive" src="http://placehold.it/300x250" />)></Box>),
  (<Box height={1} width={1} date={"11/25"} category={"normal"} context=(<img class="img-responsive" src="http://placehold.it/300x250" />)></Box>),
],
getData: function() {
  return this.data;
