...
var BoxData =  {
  data: [
  (<Box  height={6} width={9} date={"11/25"} category={"important"}>
  ...
  (<Box height={3} width={6} date={"11/25"} category={"important"}>
  ...
  (<Box height={6} width={6} date={"11/25"} category={"normal"}><img className="img-responsive" src="http://placehold.it/300x250" /></Box>),
  (<Box height={3} width={6} date={"11/25"} category={"normal"}><img className="img-responsive" src="http://placehold.it/300x250" /></Box>),
  (<Box height={6} width={3} date={"11/25"} category={"normal"}><img className="img-responsive" src="http://placehold.it/300x250" /></Box>)
],
getData: function() {
  return this.data;
},
